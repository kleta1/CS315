/**
 * This class manages the MovieList to produce a nice front-end 
...
public class MovieDatabaseManager {
	...
	/**
	 * Advanced constructor - creates a database with a list 
	...
	private void parseInputFile(String file)
	{
		...
		try {
			...
			while (in.ready()) {
				...
				//Try to parse the movie using the appropriate 
				//movie constructor.  If it fails, an exception is caught
				try {
					m = new Movie(instr);
